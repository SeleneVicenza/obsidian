- **Definizione**: Lo streaming distribuito è un approccio all'elaborazione dei dati che consente di gestire flussi continui di dati in tempo reale su un insieme di risorse distribuite (nodi, server).
